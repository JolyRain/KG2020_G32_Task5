...
public class ScreenConverter {
    ...
    public ScreenPlanet planetToScreen(HeavenlyBody body) {
        ScreenPoint position = r2s(body.getPosition());
        int radiusHoriz = r2sDistanceH(body.getRadius());
        int radiusVert = r2sDistanceV(body.getRadius());
        Color color = body.getColor();
        return new ScreenPlanet(radiusHoriz + radiusVert, position, color);
    }
    /**
